...
ax_cpu_saving.text(0.06,0.42,'RT-Xen CPU Time Saving:',fontdict=font_per[0])
ax_cpu_saving_txt = ax_cpu_saving.text(.85,0.01,'%.2f%%'%(0),fontdict=font_per[1])
...
def animate(frame):
    ...
    ax2.set_xlim( -5000/25, 5000+5000/25 )
